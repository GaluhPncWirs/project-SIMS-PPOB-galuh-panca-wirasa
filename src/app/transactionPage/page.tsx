    ...
    <ContainerRoot>
      <div className="pt-5 sm:pt-7 md:pt-20">
        ...
        <div className="mt-5 sm:mt-7 px-4 md:px-0">
          ...
          {isLoading ? (
            <div className="mt-4 sm:mt-5 grid grid-cols-1 gap-y-4 sm:gap-y-5 md:gap-y-7 animate-pulse">
              {Array.from({ length: 5 }).map((_, index) => (
                <div
                  key={index}
                  className="border-2 border-[#e8e8e8] py-3 sm:py-3.5 px-4 sm:px-6 md:px-7 rounded-lg"
                >
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-0 mb-2 sm:mb-2.5">
                    <div className="flex gap-x-2 sm:gap-x-3 items-center">
                      <div className="size-5 sm:size-6 rounded-full bg-gray-200 " />

                      <div className="h-5 sm:h-6 w-28 sm:w-32 md:w-36 rounded bg-gray-200" />
                    </div>

                    <div className="h-3 sm:h-4 w-32 sm:w-40 md:w-48 rounded bg-gray-200" />
                  </div>

                  <div className="h-3 sm:h-4 w-24 sm:w-28 md:w-32 rounded bg-gray-200" />
                </div>
              ))}
            </div>
          ) : (
